...
public class ApiLoginExtension implements BeforeEachCallback, ParameterResolver {
    ...
    private UserJson enrichUserWithAllData(UserJson user) {
        ...
        System.out.println("Categories: " + categories.size() + ", Spends: " + spends.size());
        System.out.println("Friends: " + friends.size() +
                (friends.isEmpty() ? "" : " (" + friends.stream().map(UserdataUserJson::username).reduce((a, b) -> a + ", " + b).orElse("") + ")"));
        System.out.println("Income invitations: " + incomeInvitations.size() +
                (incomeInvitations.isEmpty() ? "" : " (" + incomeInvitations.stream().map(UserdataUserJson::username).reduce((a, b) -> a + ", " + b).orElse("") + ")"));
        System.out.println("Outcome invitations: " + outcomeInvitations.size() +
                (outcomeInvitations.isEmpty() ? "" : " (" + outcomeInvitations.stream().map(UserdataUserJson::username).reduce((a, b) -> a + ", " + b).orElse("") + ")"));
